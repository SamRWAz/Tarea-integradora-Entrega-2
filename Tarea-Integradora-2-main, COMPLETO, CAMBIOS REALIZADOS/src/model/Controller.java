...
public class Controller {
	...
	public String publishKnowledgeUnit(int id, String url) {
    	...
    	msg += project.publishKnowledgeUnit(id, url);
	...
	public String searchKnowledgeUnits(){
        ...
        for(int i = 0; i < projects.length; i++){
            ...
            if(projects[i]!=null){
                msg += projects[i].searchKnowledgeUnits();
            }
        }
	...
	public String getProyectMostKnowledgeUnits() {
        ...
        for(int i = 0; i < projects.length; i++){
            ...
            if(projects[i]!=null){
				...
				nombre = projects[i].getName();
                msg += projects[i].getProyectMostKnowledgeUnits(i, nombre);
            }
        }
	...
	public String searchColaboradorName(String nomBusqueda){
		...
		for(int i = 0; i < projects.length; i++){
            ...
            if(projects[i]!=null){
                ...
                msg += projects[i].searchColaboradorName(nomBusqueda);
            }
        }
