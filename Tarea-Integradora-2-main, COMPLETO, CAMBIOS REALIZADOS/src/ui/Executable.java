...
public class Executable {
    ...
    private void publishKnowledgeUnit() {
        ...
        if(consulta.equals("")){
            ...
            System.out.println(controller.publishKnowledgeUnit(opcion-1, url));
    ...
    public void showLearnedLessonsKnowledgeUnits() {
        ...
        if(consulta.equals("")){
            ...
            System.out.println("No hay capsulas de conocimiento registradas");
        }else {
    ...
    public void searchColaboradorName(){

        System.out.println("Digite el nombre del colaborador que desea buscar, le diremos si ha realizado algún capsula");
        String nomBusqueda = reader.nextLine();

        String consulta = controller.searchColaboradorName(nomBusqueda);

        if(consulta.equals("")){

            System.out.println("No hay capsulas de conocimiento hechas por esa persona");
        }else {
